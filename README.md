...
### 🌐 배포 완료 후 웹사이트 접속 주소
* 📊 **따릉이 요약 대시보드 (메인)**: [https://kimsaemi.github.io/frist_board/](https://kimsaemi.github.io/frist_board/)
* 🚲 **따릉이 지도 대시보드**: [https://kimsaemi.github.io/frist_board/따릉이_지도_대시보드.html](https://kimsaemi.github.io/frist_board/따릉이_지도_대시보드.html)
...
```
.
├── index.html                                        # 메인 따릉이 요약 대시보드 (총 이용건수 & 운영 대여소 수)
├── style.css                                         # 대시보드 CSS 스타일
├── app.js                                            # 대시보드 JS 로직 & Chart.js
